...
class SignUp: UIViewController {
    ...
    func setupViews() {
        ...
        displaynameField.attributedPlaceholder = NSAttributedString(string:"display name", attributes: [NSAttributedString.Key.foregroundColor: UIColor.black])
    ...
    @objc func signupTapped() {
        if usernameField.text=="" {
            ...
            displaynameError.text="Invalid Username"
        }
            ...
            delegate?.createUser(i: User(username: usernameField.text!, displayname: displaynameField.text!, password: passwordField.text!, social: socialField.text!))
