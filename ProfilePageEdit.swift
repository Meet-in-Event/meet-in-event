...
class ProfilePageEdit: UIViewController {
    ...
    func setupViews() {
        ...
        usernameField.attributedPlaceholder = NSAttributedString(string:user.username, attributes: [NSAttributedString.Key.foregroundColor: UIColor.black])
        ...
        displaynameField.attributedPlaceholder = NSAttributedString(string:user.displayname, attributes: [NSAttributedString.Key.foregroundColor: UIColor.black])
    ...
    @objc func saveTapped() {
        ...
        delegate?.setUser(i: User(username: usernameField.text!, displayname: displaynameField.text!, password: passwordField.text!))
